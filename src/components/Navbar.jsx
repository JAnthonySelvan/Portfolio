...
export default function Navbar() {
  ...
  return (
    <>
      {/* Wrapper prevents any child from overflowing viewport width */}
      <div
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
              >
                <span className="text-xl sm:text-2xl font-poppins font-bold text-gradient truncate">
                  ANTHONYSELVAN J
                </span>
              </motion.a>
          ...
          <AnimatePresence>
            {mobileMenuOpen && (
              <motion.div
                ...
                className="lg:hidden"
              >
                <div className="glass mt-2 mx-4 rounded-xl">
